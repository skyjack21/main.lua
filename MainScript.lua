-- [[ SKYJACK V.2.0: STEALTH UI & FINAL FUNCTIONALITY ]] --
-- Fix by AI Research:
-- - [REDESIGN] Desain dirombak total dari nol dengan tema "Stealth" (Dark & Electric Blue).
-- - [ADDED] UIListLayout untuk tata letak tombol yang 100% rapi dan otomatis.
-- - [ADDED] Fitur Minimize & Close pada panel utama.
-- - [FIXED] Bug "TextBox" pada panel login diperbaiki secara permanen.
...
-- [[ 1. PREMIUM UI BUILDER (STEALTH) ]] --
local function BuildUI()
    if pgui:FindFirstChild("SKYJACK_V2.0") then pgui.SKYJACK_V2.0:Destroy() end
    local Screen = Instance.new("ScreenGui", pgui)
    Screen.Name = "SKYJACK_V2.0"
    ...
    local theme = {
        ...
        Accent = Color3.fromRGB(0, 191, 255), -- Electric Blue
    ...
    KeyInput.Position = UDim2.new(0.5, 0, 0, 70)
    KeyInput.PlaceholderText = "Enter Key..." -- [FIXED]
    KeyInput.Text = "" -- Memastikan teks kosong
    ...
    CheckBtn.Position = UDim2.new(0.5, 0, 0, 125)
    ...
    Status.Position = UDim2.new(0.5, 0, 0, 180)
    ...
    Instance.new("UIStroke", Main).Color = theme.Secondary

    local Title = Instance.new("TextLabel", Main)
    Title.Size = UDim2.new(1, 0, 0, 45)
    Title.BackgroundColor3 = theme.Secondary
    Title.Text = "SKYJACK V.2.0"
    ...
    ButtonContainer.ScrollBarImageColor3 = theme.Accent
    ...
    return Screen, KeyPanel, Main, CheckBtn, KeyInput, Status, theme, ButtonContainer, CloseBtn, MinimizeBtn
end

local Screen, KeyPanel, Main, CheckBtn, KeyInput, Status, theme, ButtonContainer, CloseBtn, MinimizeBtn = BuildUI()
