-- [[ SKYJACK RBX v340: ULTRA-APEX - THE COMPLETE FINAL CORE ]] --
...
local Buttons = {}
local Index = 1
local SpeedVal = 2.4 -- Locked for Top Time

-- [[ 1. ABSOLUTE STEALTH ENGINE ]] --
    ...
    for _, v in pairs(lp.Character:GetDescendants()) do
        if v:IsA("BasePart") then
            if Toggles.WallPass then
                ...
                -- Balikkan ke normal kecuali RootPart
...
-- [[ 4. DESIGN: PREMIUM MINIMALIST (ULTRA SLIM) ]] --
local function BuildUI()
    for _, v in pairs(pgui:GetChildren()) do if v.Name == "ULTRA_APEX" then v:Destroy() end end
    Screen = Instance.new("ScreenGui", pgui)
    Screen.Name = "ULTRA_APEX"
...
uis.InputBegan:Connect(function(k, g)
    ...
    elseif k.KeyCode == Enum.KeyCode.Return then 
        ...
        if key == "HideName" then ApplyStealth(lp.Character) end
        Refresh() 
    end
end)
